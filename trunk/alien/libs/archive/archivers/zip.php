...
/**
 * This class is based on the EasyZIP class
 * by huda m elmatsani (justhuda@netscape.net)
 * Author: Oleg A Shimchik (wanderer@php.net)
 */
...
class zip {
	...
	private $splitted = 0;
	private $split_signature = "";
	private $split_size = 1;
	private $split_offset = 0;
	private $disk_number = 1;
